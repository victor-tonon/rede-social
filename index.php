<?php
  ...
  if (isset($_POST['publish'])) {
    if ($_FILES["file"]["error"] > 0){
      ...
      if ($texto == ""){
        echo "<script>alert('Escreva algo para publicar!')</script>";
      }else{
...
<html>
  <header>
    ...
    <style type="text/css">
      ...
      div#publish input[type="submit"]{width: 70px; height: 25px; border-radius: 3px; float: right; margin-right: 15px; border: none; margin-top: 5px; background: #3e4684; color: #dde5f4; cursor: pointer;}
